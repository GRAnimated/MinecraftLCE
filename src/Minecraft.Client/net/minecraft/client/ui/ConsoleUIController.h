...
public:
    ...
    int m_flags;
    int m_dword444;
    std::vector<UIControl*> m_uicontroLs[3240];
    char m_byte13408[4];
    char m_byte1340C;
    void* m_qword13410;
    char m_byte13418;
    ...
    char m_byte1356C;
    void* m_qword13570;
    nn::os::MutexType m_mutex5;
    char m_byte13598;
    int m_dword1359C;
    void* m_qword135A0;
    char m_gap135A8[16];
    std::unordered_map<int, UIScene*> m_uiScenes;
    nn::os::MutexType m_mutex6;
    int m_viewportTouchOffset1;
