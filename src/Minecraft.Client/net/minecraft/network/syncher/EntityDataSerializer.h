...
public:
    EntityDataSerializer(EntityDataSerializerEnum::EEntityDataSerializer type) : mType(type) {}
    ...
    std::unordered_map<int, EntityDataAccessor<T>*> mAccessors;
    EntityDataSerializerEnum::EEntityDataSerializer mType;
};
