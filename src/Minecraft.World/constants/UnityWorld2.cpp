...
MappedRegistry<ResourceLocation, eINSTANCEOF, std::hash<ResourceLocation>, std::equal_to<ResourceLocation>, std::hash<eINSTANCEOF>, std::equal_to<eINSTANCEOF>> ResourceLocation::Registry =
    MappedRegistry<ResourceLocation, eINSTANCEOF, std::hash<ResourceLocation>, std::equal_to<ResourceLocation>, std::hash<eINSTANCEOF>, std::equal_to<eINSTANCEOF>>();
