...
class MobEffects {
public:
    static MobEffect* SPEED;
    static MobEffect* SLOWNESS;
    static MobEffect* HASTE;
    static MobEffect* MINING_FATIGUE;
    static MobEffect* STRENGTH;
    static MobEffect* INSTANT_HEALTH;
    static MobEffect* INSTANT_DAMAGE;
    static MobEffect* JUMP_BOOST;
    static MobEffect* NAUSEA;
    static MobEffect* REGENERATION;
    static MobEffect* RESISTANCE;
