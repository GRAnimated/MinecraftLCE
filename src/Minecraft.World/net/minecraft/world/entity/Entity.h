...
public:
    ...
    int m_boardingCooldown;
    std::shared_ptr<Entity> m_vehicle;
    bool m_forcedLoading;
    Level* m_level;
    double m_xo;
    double m_yo;
    double m_zo;
    ...
    double m_y;
    double m_z;
    double m_deltaMovementX;
    double m_deltaMovementY;
    double m_deltaMovementZ;
    float m_yRot;
    float m_xRot;
    float m_yRotO;
    float m_xRotO;
    AABB* m_boundingBox;
    bool m_onGround;
    bool m_hasHorizontalCollision;
    bool m_hasVerticalCollision;
    bool m_hasCollision;
    bool m_isHurtMarked;
    int m_remainingFireTicks;
    bool m_fieldCc;
    int m_fieldD0;
    int m_fieldD4;
    int m_fieldD8;
    ...
    bool m_isFirstTick;
    bool m_isImmuneToFire;
    std::shared_ptr<SynchedEntityData> m_entityData;
    bool m_isInChunk;
    int m_xChunk;
    int m_yChunk;
    int m_zChunk;
    ...
    bool m_isInsidePortal;
    int m_portalTime;
    int m_dimensionId;
    BlockPos m_portalEntranceBlock;
    Vec3* m_portalEntranceOffset;
    Direction* m_portalEntranceForwards;
    std::wstring m_stringUuid;
    std::wstring m_customName;
    CommandStats* m_commandStats;
    NonNullList<not_null_ptr<ItemInstance>> m_inventory;
    bool m_isGlowing;
    bool m_isInvulnerable;
    bool m_hasTeleported;
    std::set<std::wstring> m_tags;
    void* m_field240;
    arrayWithLength<double> m_pistonDeltas;
    long m_pistonDeltasGameTime;
    int m_type;
