...
CustomizableSourceSettings::CustomizableSourceSettings(CustomizableSourceSettings::Builder* builder) {
    ...
    this->useStrongholds = builder->byte_4C;
    this->useVillages = builder->byte_4D;
    this->useMineshafts = builder->byte_4E;
    this->useScatteredFeatures = builder->byte_4F;
    this->useOceanMonuments = builder->byte_50;
    this->useWoodlandMansions = builder->byte_51;
