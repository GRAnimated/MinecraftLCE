...
public:
    ...
    static DataOutputStream* getChunkDataOutputStream(ConsoleSaveFile* save, const std::wstring& unk, int x,
                                                      int z, bool unk2) {
        return sInstance->_getChunkDataOutputStream(save, unk, x, z, unk2);
    }
