...
public:
    ...
    virtual uint getSkyColor(float);
    ...
    virtual uint getGrassColor(BlockPos const*);
    virtual uint getFoliageColor(BlockPos const*);
    virtual void setGrassColor(BlockPos const*, uint);
    virtual void setFoliageColor(BlockPos const*, uint);
