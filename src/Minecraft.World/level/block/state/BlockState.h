...
public:
    ...
    virtual void isSolid() const = 0;
    virtual void isValidSpawn(std::shared_ptr<Entity>) const = 0;
    virtual void getLightBlock() const = 0;
    virtual void getLightEmission() const = 0;
    virtual void isTranslucent() const = 0;
    ...
    virtual void isCubeShaped() const = 0;
    ...
    virtual void isSolidBlockingCube() const = 0;
    virtual void isSolidBlockingCubeAndNotSignalSource() const = 0;
    virtual void isSignalSource() const = 0;
    ...
    virtual void shouldRenderFace(LevelSource*, BlockPos const&, Direction const*) const = 0;
    virtual void isSolidRender() const = 0;
    ...
    virtual void isTopSolidBlocking() const = 0;
    virtual void getOffset(LevelSource*, BlockPos const&) const = 0;
    virtual void isViewBlocking() const = 0;
