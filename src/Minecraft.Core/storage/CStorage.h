...
class CStorage : public C4JStorage {
    public:
    void Tick() override;
    void Init(unsigned int, const wchar_t *, const char *, int, int (*)(void *, C4JStorage::ESavingMessage, int), void *, const char *, void *) override;
    ...
    void SetDefaultImages(unsigned char *, unsigned int, unsigned char *, unsigned int, unsigned char *, unsigned int) override;
    ...
    void GetSavesInfo(int, int (*)(void *, struct SAVE_DETAILS *, bool), void *, const char *) override; // TODO: what is SAVE_DETAILS?
    void ReturnSavesInfo() override;
    void ClearSavesInfo() override;
    void LoadSaveDataThumbnail(struct SAVE_INFO *, int (*)(void *, unsigned char *, unsigned int), void *) override; // TODO: what is SAVE_INFO? Probably that tEXt chunk
    void LoadSaveData(struct SAVE_INFO *, int (*)(void *, bool, bool), void *) override; // TODO: what is SAVE_INFO?
    ...
    void InitialiseProfileData(unsigned short, unsigned int, unsigned int, unsigned int *, int, unsigned int *) override;
    void SetDefaultOptionsCallback(int (*)(void *, C4JStorage::PROFILESETTINGS *, int), void *) override;
    void SetOptionsDataCallback(int (*)(void *, int, unsigned short, C4JStorage::eOptionsCallback), void *) override;
