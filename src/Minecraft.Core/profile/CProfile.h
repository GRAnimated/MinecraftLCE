...
class CProfile : public C_4JProfile {
    ...
    void Initialise(const void *, const void *, unsigned short, unsigned int, unsigned int, unsigned int *, int, unsigned int *) override;
    int GetLockedProfile() override;
    void SetLockedProfile(int) override; // guessing int here is flags provided by the OS when getting the user
