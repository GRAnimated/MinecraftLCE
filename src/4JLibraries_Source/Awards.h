...
struct Awards {
    static constexpr int sAchievementSlots[]  // also used to register the textures
        = {0x0,  0x1,  0x2,  0x3,  0x4,  0x5,  0x6,  0x7,  0x8,  0x9,  0xA,  0xB,  0xC,  0xD,  0xE,
           0xF,  0x10, 0x11, 0x12, 0x13, 0x16, 0x17, 0x18, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20,
    ...
    static constexpr AwardInfo sAwards[] = {
        ...
        {0x04, L"MCTrophy_12", 5, StringIDs::HotTopic,
         StringIDs::ConstructAFurnaceOutOfEightCobblestoneBlocks},
        ...
        {0x24, L"MCTrophy_29", 0x1E, StringIDs::Librarian,
        ...
        {0x2E, L"MCTrophy_42", 0x2B, StringIDs::StayinFrosty,
         StringIDs::SwimInLavaWhileHavingFireResistanceEffect},
        {0x2F, L"MCTrophy_43", 0x2C, StringIDs::ChestfulOfCobblestone,
         StringIDs::Mine1728CobblestoneAndPlaceItInAChest},
        {0x30, L"MCTrophy_44", 0x2D, StringIDs::RenewableEnergy,
        ...
        {0x49, L"MCTrophy_69", 0x49, StringIDs::TasteOfYourOwnMedicine,
         StringIDs::PoisonAWitchWithASplashPotion},
        {0x4A, L"MCTrophy_70", 0x4A, StringIDs::BeamMeUp, StringIDs::TeleportOver100MetersFromASingleThrow},
        {0x4B, L"MCTrophy_71", 0x4B, StringIDs::MapRoom_1,
         StringIDs::PlaceAFullyExploredMapIntoAnItemFrame_1},
        {0x4C, L"MCTrophy_72", 0x4C, StringIDs::Camouflage_1,
         StringIDs::KillAMobWhileWearingSameTypeOfMobHead_1},
        ...
        {0x51, L"MCTrophy_77", 0x51, StringIDs::Snowplough,
         StringIDs::PushThreePlayersIntoLavaUsingSnowballs},
        ...
        {0x55, L"MCTrophy_81", 0x55, StringIDs::GreatViewFromUpHere,
        ...
        {0x58, L"MCTrophy_84", 0x58, StringIDs::SoIGotThatGoingForMe,
