...
extern "C" void nnMain() {
    ...
    CProfile::sInstance->Initialise(L"", L"", 33, 5, 4, &unk_71017C17BC, 7776,
                                    &dword_71017C0AB0);
    ...
    #warning It is unknown what the function provided at the end of this call is. Looks more like what a branch would lead to as it's stored inside this method. It originally called for bool * in that area.
    CStorage::sInstance->Init(0, L10N::GetString(3232918502), "savegame.dat", 51000000, CConsoleMinecraftApp::DisplaySavingMessageNX, &CConsoleMinecraftApp::sInstance, what, nullptr);
    CProfile::sInstance->SetSignInChangeCallback(CMinecraftApp::SignInChangeCallback, &CConsoleMinecraftApp::sInstance);
    CProfile::sInstance->SetProfileReadErrorCallback(CMinecraftApp::ProfileReadErrorCallback, &CConsoleMinecraftApp::sInstance);
    CStorage::sInstance->InitialiseProfileData(33, 5, 4, &unk_71017C17BC, 7776, &dword_71017C0AB0);
    CStorage::sInstance->SetDefaultOptionsCallback(CMinecraftApp::DefaultOptionsCallback, &CConsoleMinecraftApp::sInstance);
    CStorage::sInstance->SetOptionsDataCallback(CMinecraftApp::OptionsDataCallback, &CConsoleMinecraftApp::sInstance);
    CStorage::sInstance->SetOldProfileVersionCallback(GameSettings::OldProfileVersionCallback, &CConsoleMinecraftApp::sInstance);
    ...
    CProfile::sInstance->SetUpsellCallback(CMinecraftApp::UpsellReturnedCallback, &CConsoleMinecraftApp::sInstance);
